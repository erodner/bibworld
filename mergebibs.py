...
parser.add_argument(
    "-o", "--out", help="Output file for the merging", default="merge.bib"
)
parser.add_argument(
    "bibfiles", nargs="+", help="Bibtex files to merge (order is important)"
)
parser.add_argument(
    "-q", "--query", help="Query in JSON format for the first bib file", default=None
)
parser.add_argument(
    "-r", "--removefields", help="Remove fields from the first bib file", default=""
)
